...
description: Delegate a task to the GitHub Copilot CLI (non-interactive, yolo) to conserve Codex tokens. Use for multi-file scaffolding, UI component work, CI workflows, and git/GitHub chores (branches, commits, pushes, PRs — it has built-in GitHub MCP). Codex writes the spec and reviews the diff; Copilot burns Copilot credits doing the typing.
---
