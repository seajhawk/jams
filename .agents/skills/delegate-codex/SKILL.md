---
name: delegate-codex
description: Delegate a well-specified coding task to the OpenAI Codex CLI (non-interactive, full-auto) to conserve Codex tokens. Use for surgical implementation slices — Drizzle schema/migrations, API routes, worker measure providers, tests, refactors. Codex writes the spec and reviews the diff; Codex burns OpenAI credits doing the typing.
---
...
If Codex stalls or misunderstands twice, stop retrying — fix the spec or escalate to Codex implementation.
